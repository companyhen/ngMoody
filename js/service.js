 ...
 //    })
	...
	function listGenres(){
		for(i=0; i<genres.length; i++){
			...
			genreData[i] = $http.get('http://api.soundcloud.com/tracks.json' + client_id + '&q=' + moods + '&genres=' + genre + '&limit=25&duration[from]=100000&duration[to]=400000&streamable=true');
		}
